...
import styles from "../components/TableHead.module.css";
  ...
  if (props.type === "1") {
    header = (
      <div className={styles.row + " " + styles.header + " " + styles.blue}>
        ...
        <div className={styles.cell}>Manage Items</div>
    ...
    header = (
      <div className={styles.row + " " + styles.header + " " + styles.blue}>
        ...
        <div className={styles.cell}>Completed On Date</div>
        <div className={styles.cell}>Tags</div>
        <div className={styles.cell}>Mark Complete</div>
        <div className={styles.cell}>Move to </div>
        <div className={styles.cell}>Edit</div>
        <div className={styles.cell}>Delete</div>
      </div>
    );
